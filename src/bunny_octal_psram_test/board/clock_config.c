...
- {id: FLEXSPI_clock.outFreq, value: 133 MHz}
- {id: FRO_12M_clock.outFreq, value: 12 MHz}
- {id: FRO_HF_clock.outFreq, value: 48 MHz}
- {id: MAIN_clock.outFreq, value: 150 MHz}
- {id: PLL0_CLK_clock.outFreq, value: 150 MHz}
- {id: PLL1_CLK_clock.outFreq, value: 133 MHz}
...
- {id: SCG.PLL0M_MULT.scale, value: '100', locked: true}
- {id: SCG.PLL0_NDIV.scale, value: '8', locked: true}
- {id: SCG.PLL1M_MULT.scale, value: '4462739456', locked: true}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    const pll_setup_t pll0Setup = {
        .pllctrl = SCG_APLLCTRL_SOURCE(0U) | SCG_APLLCTRL_SELI(53U) | SCG_APLLCTRL_SELP(26U),
    ...
    const pll_setup_t pll1Setup = {
        ...
        .pllsscg = {(SCG_SPLLSSCG0_SS_MDIV_LSB(167772160U)),((SCG0->SPLLSSCG1 & ~SCG_SPLLSSCG1_SS_PD_MASK) | SCG_SPLLSSCG1_SS_MDIV_MSB(1U) | (uint32_t)(kSS_MF_512) | (uint32_t)(kSS_MR_K0) | (uint32_t)(kSS_MC_NOC) | SCG_SPLLSSCG1_SEL_SS_MDIV_MASK)},
        .pllRate = 133000000U
    };
    ...
    CLOCK_AttachClk(kPLL1_to_FLEXSPI);                 /*!< Switch FLEXSPI to PLL1 */

    /*!< Set up dividers */
    CLOCK_SetClkDiv(kCLOCK_DivAhbClk, 1U);           /*!< Set AHBCLKDIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivFlexspiClk, 1U);           /*!< Set FLEXSPICLKDIV divider to value 1 */
